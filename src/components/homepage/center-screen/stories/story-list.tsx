...
import { addStory } from "@/lib/actions/actions.create_stories";
...
export function StoryList({ stories, userId }: { stories: StoryWithUser[]; userId: string }) {
